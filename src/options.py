...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--model_path", type=str, default="facebook/contriever", help="path for retraining")
        ...
        # dataset parameters
        self.parser.add_argument("--per_gpu_batch_size", default=20, type=int, help="Batch size per GPU for training.")
        self.parser.add_argument(
            "--per_gpu_eval_batch_size", default=64, type=int, help="Batch size per GPU for evaluation."
        )
        self.parser.add_argument("--total_steps", type=int, default=5000)
